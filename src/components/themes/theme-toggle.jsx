    ...
    return (
        ...
        <button onClick={() => setTheme(theme === "dark" ? "light" : "dark")} type="button" aria-label="Toggle dark mode" data-testid="dark-theme-toggle"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                 stroke="currentColor" stroke-width="0" viewBox="0 0 20 20" aria-label="Currently dark mode"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                 stroke="currentColor" stroke-width="0" viewBox="0 0 20 20"
                 aria-label="Currently light mode" className="h-5 w-5 dark:hidden">
                <path stroke="none"
